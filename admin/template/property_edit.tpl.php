    ...
    <div class="mpstopic-category">
        <div class="panel-tab">
            <ul class="clearfix tab-list">
                ...
                <li><a href="?part=edit&id=<?=$row['id']?>" class="current">编辑信息</a></li>
            </ul>
        </div>
    </div>
</div>
...
<tr class="firstr">
<td colspan="2">
    <div class="left"><a href="javascript:collapse_change('1')">信息</a></div>
